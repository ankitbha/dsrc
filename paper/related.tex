...
feed is a third-party dependency with an unreported lag, and carries
different risks, but is suitable to achieve a minimum viable deployment.
...
around it has to do to keep the detector's output honest when it is wrong.
