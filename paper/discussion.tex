...
Evaluation should sweep penetration, compliance, message loss, sensing noise, and demand bursts across a topology ladder from rings to merges to inverted trees, directly compare bottleneck seeding against uniform adoption at equal fleet size, and report throughput, jam fraction, and delay alongside hard braking, collisions, and follower delay, so a network gain is never bought by making human traffic less safe.
