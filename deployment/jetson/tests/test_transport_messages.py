...
#: `normal` appears in more than one spec block legitimately: it is a
#: headway bin and a merge mode. Any other overlap is drift.
...
POPULATED_OPTIONALS = {
    channel: (
        ...
        else set(a_time_sync_ping_with_prev().to_wire()[0])
